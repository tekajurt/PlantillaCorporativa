  ...
  const posts = [
    {
      ...
      children:
        "Inscripciones abiertas para talleres de figuras, danza y música. Cupos limitados.",
    },
    {
    ...
    },
    {
      ...
      children:
        "Consulta el calendario actualizado para los próximos ensayos y presentaciones.",
    },
  ];
  return (
    <Section id="blog">
      ...
      <p className="mb-4">
        Últimas novedades de la Escuela: convocatorias, reconocimientos y fechas
        importantes.
      </p>
